...
<style>
  ...
  .content-wrapper {
      ...
      align-items: center;
      flex-direction: row;
      padding-left: 2rem; /* Adjust for spacing */
  }
  ...
  /* Ensure vertical text is vertically centered */
...
<div class="w-full mx-auto p-4 bg-[#F5F3F1] rounded-lg shadow-lg">
  <div class="relative mb-4">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 content-wrapper mx-auto gap-8">
          <!-- Text Content -->
          <div class="text-content text-center lg:text-left">
              <p class="text-3xl font-semibold text-gray-800 mt-2">
                  ...
                  <a href="#" class="inline-flex items-center text-sm text-black hover:underline">
                      Read More
                      <img src="{{ asset('asset/img/arrow.png') }}" alt="Arrow pointing right" class="h-6 w-6 ml-2">
                  </a>
              </p>
          </div>
          ...
          <div class="image-wrapper">
              <img src="{{ asset('asset/img/blog-jewellery.jpg') }}" alt="Jewellery for Lehenga" class="w-full h-auto">
          </div>
      </div>
  </div>
</div>
...
<div class="w-full mx-auto px-4 md:px-24 bg-[#F5F3F1] mt-0">
  <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      
      <!-- First Column -->
      <div class="flex flex-col md:flex-row bg-[#F5F3F1] p-4 gap-4">
          <div class="w-full h-full overflow-hidden rounded-md">
              <img src="{{ asset('asset/img/j1.gif') }}" alt="Woman wearing necklace 1" class="w-full h-full object-cover rounded-md">
          </div>
          <div class="flex flex-col justify-center">
              <h2 class="text-xl md:text-2xl font-semibold mb-2">How to choose the best jewellery for your gown</h2>
              <p class="text-gray-600 text-sm md:text-base">Do you choose the gown first or the jewellery? That is a question that does crop up from time to time.</p>
          </div>
      </div>
      ...
      <div class="bg-[#F5F3F1] p-4">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div class="w-full h-full overflow-hidden rounded-md">
                  <img src="{{ asset('asset/img/jr1.jpg') }}" alt="Ring" class="w-full h-full object-cover rounded-md">
              </div>
              <div class="flex flex-col justify-center">
                  <h2 class="text-xl md:text-2xl font-semibold mb-2">How to choose the best jewellery for your gown</h2>
                  <p class="text-gray-600 text-sm md:text-base">Do you choose the gown first or the jewellery? That is a question that does crop up from time to time.</p>
...
<div class="bg-black">
  ...
  <div class="bg-gradient-to-r from-[#E56EEB] to-[#8A63FA] p-8 rounded-lg mb-8 lg:px-32 py-8 mx-4 md:mx-32 my-12">
    ...
    <form class="flex flex-col md:flex-row">
        <!-- Email Input -->
        <input type="email" placeholder="Email" class="flex-grow p-3 rounded-t-lg md:rounded-l-lg md:rounded-t-none focus:outline-none mb-4 md:mb-0" required>
        
        <!-- Submit Button -->
        <button type="submit" class="bg-gray-800 text-white px-6 py-3 rounded-b-lg md:rounded-r-lg md:rounded-b-none hover:bg-gray-700 transition duration-300">
            SUBSCRIBE
        </button>
    </form>
</div>
