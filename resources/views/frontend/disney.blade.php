...
@section('content')
    ...
    {{-- fjid --}}
    <div class="bg-[#21033E] text-white p-6 md:p-10 text-center lg:py-24">
    ...
    {{-- grid --}}
    <div class="bg-[#21033E] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 p-8">
        <div>
    ...
    <div class="flex justify-center items-center">
        <video src="{{ asset('asset/videos/Disney-website.mp4') }}" 
