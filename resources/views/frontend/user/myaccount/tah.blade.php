        ...
        <div class="text-center w-full">
            ...
            <div class="flex justify-center items-center mb-8">
                ...
                <svg class="w-24 h-24 text-purple-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    ...
                    <!-- Add the rest of the icon path to match the image -->
                </svg>
            </div>

            <!-- Button -->
            <button
                class="px-12 py-3 bg-gradient-to-r from-purple-400 to-pink-400 text-white font-semibold rounded-lg shadow-md hover:from-purple-500 hover:to-pink-500 transition duration-300">
                Continue Shopping
            </button>
        </div>
