...
<style>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 m-4 pt-4">
        <div class="flex items-center justify-center">
            <img src="{{ asset('asset/img/Responsive-11.jpg') }}" alt="Best Image 12" class="w-full h-auto rounded shadow-lg">
        </div>
...
<div class="relative w-full h-auto mx-auto overflow-hidden shadow-2xl grid grid-cols-1 md:grid-cols-3 px-4 md:px-8">
    ...
    <div class="relative col-span-2 pt-[56.25%]" dir="ltr">
        <iframe 
            ...
            src="https://www.youtube.com/embed/kYOP52BUZTI?si=V0wW0Zp2QNuG2wlp" 
    ...
    <div class="flex items-center justify-center bg-[#381a40] p-6 rounded-b-xl md:rounded-s-3xl col-span-1" dir="rtl">
...
<div class="container mx-auto p-4 py-24">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="relative group overflow-hidden">
            <img 
                src="{{ asset('asset/img/Collection_disney_11.jpg') }}" 
        ...
        <div class="relative group overflow-hidden flex items-center justify-center -mt-20 mb-4">
            <img 
                src="{{ asset('asset/img/Utsav.jpg') }}" 
                alt="Utsav Collection" 
            ...
            >
            <button class="absolute bottom-0 text-black py-0 px-4 rounded-lg opacity-90 hover:opacity-100 transition duration-300">
        ...
        <div class="relative group overflow-hidden">
            <img 
                src="{{ asset('asset/img/Collection_Harry_potter.jpg') }}" 
...
<div class="relative w-full h-auto mx-auto overflow-hidden py-4 grid grid-cols-1 md:grid-cols-3 px-4 md:px-8">
    ...
    <div class="relative col-span-2 pt-[56.25%]" dir="ltr">
        <iframe 
            class="absolute top-0 left-0 w-full h-full rounded-t-xl md:rounded-s-3xl" 
            src="https://www.youtube.com/embed/xuuNZQwhEn4?si=wAVU0dgJMPh7Ijs1" 
    ...
    <!-- Overlay and Text Section -->
    <aside class="flex items-center justify-center bg-[#160618] p-6 rounded-b-xl md:rounded-s-3xl col-span-1" dir="rtl">
        <div class="text-right max-w-md">
            <h2 class="text-6xl md:text-5xl text-pretty text-white mb-2 drop-shadow-lg">
                <span class="cursive font-light text-balance">𝗟𝗮𝘁𝗲𝘀𝘁</span><br>𝒟𝑒𝓈𝒾𝑔𝓃
            </h2>
    ...
    <div class="  flex flex-col md:flex-row gap-40 justify-center">
        ...
        <div class="w-1/3 relative">
            <div class="absolute  inset-0 flex flex-col justify-center items-center text-center text-black rounded-lg p-4 transform translate-x-1/2">
                ...
                <button class="bg-gradient-to-r from-pink-500 to-purple-600 text-black px-4 py-2 rounded text-sm transition duration-300 hover:from-pink-600 hover:to-purple-700">
        ...
        <div class="w-1/3 relative">
            <div class="absolute  inset-0 flex flex-col justify-center items-center text-center text-black rounded-lg p-4 transform translate-x-1/2">
                ...
                <div class="mb-4">
                    <input type="text" placeholder="Enter Pincode or City" class="w-full p-2 border border-pink-500 to-purple-500 rounded text-sm">
                </div>
...
<div class="container mx-auto px-4 py-6 my-12">
    <div class="bg-gray-50 grid grid-cols-2 p-6 py-8 gap-4">
        ...
        <div class="text-center pt-8">
            <h1 class="text-8xl font-light bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent">GOLD</h1>
            <p class="text-3xl bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent">EXCHANGE PROGRAM</p>
        </div>
        ...
        <div class="mt-8">
            ...
            <button class="mt-4 bg-gradient-to-r from-pink-500 to-purple-500 text-white px-6 py-2 rounded transition duration-300 hover:from-pink-600 hover:to-purple-600">
                Know More
            </button>
        </div>
    </div>
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="inline-flex rounded-md shadow-sm" role="group">
            <button id="women-tab" type="button" class="tab-btn px-4 py-2 text-sm font-medium text-white bg-purple-500 rounded-l-lg hover:bg-purple-600 focus:ring-2 focus:ring-purple-500" data-tab="slider1">
                WOMEN
            </button>
            <button id="men-tab" type="button" class="tab-btn px-4 py-2 text-sm font-medium text-gray-700 bg-white rounded-r-lg border border-gray-200 hover:bg-gray-100 hover:text-purple-700 focus:ring-2 focus:ring-purple-500" data-tab="slider2">
                MEN
            </button>
        </div>
    </div>
    ...
    <div id="slider1" class="tab-content">
        <div class="glide" id="glide1">
            <div class="glide__track" data-glide-el="track">
                <ul class="glide__slides flex space-x-6">
                    ...
                    <li class="glide__slide w-48 flex-shrink-0">
                        <img src="{{asset('asset/img/j1.jpg')}}" alt="Glitter Miracle Diamond Ring" class="w-full h-48 object-cover rounded-lg mb-2">
                    ...
                    <!-- Product 2 -->
                    <li class="glide__slide w-48 flex-shrink-0">
                        <img src="{{asset('asset/img/j2.jpg')}}" alt="Intertwined Slim Diamond Ring" class="w-full h-48 object-cover rounded-lg mb-2">
            ...
            <div class="glide__arrows" data-glide-el="controls">
                <button class="glide__arrow glide__arrow--left absolute left-0 top-1/2 transform -translate-y-1/2 bg-white rounded-full p-2 shadow-md" data-glide-dir="<">
                ...
                <button class="glide__arrow glide__arrow--right absolute right-0 top-1/2 transform -translate-y-1/2 bg-white rounded-full p-2 shadow-md" data-glide-dir=">">
                ...
                <ul class="glide__slides">
                    ...
                    <div class="w-full md:w-1/2 lg:w-1/3 flex-shrink-0 p-2">
                        <div class="bg-white shadow-md rounded-lg overflow-hidden border border-gray-200">
                            <div class="relative">
                              <img src="{{ asset('asset/img/j5.jpg') }}" alt="Best Seller 1" class="w-full h-48 object-cover" loading="lazy"></a>
                            </div>
                            <div class="p-4">
...
<div class="main py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <!-- Large Image -->
      <div class="w-full">
        <img src="{{ asset('asset/img/j6.jpg') }}" alt="Instagram Image" class="w-full h-auto object-cover rounded-lg shadow-lg">
      </div>
  
      <!-- Smaller Image Grid -->
      <div class="grid grid-cols-3 gap-4">
        <div><img src="{{ asset('asset/img/j4.jpg') }}" alt="Instagram Image" class="w-full h-auto object-cover rounded-lg shadow-lg"></div>
        <div><img src="{{ asset('asset/img/j4.jpg') }}" alt="Instagram Image" class="w-full h-auto object-cover rounded-lg shadow-lg"></div>
        <div><img src="{{ asset('asset/img/j4.jpg') }}" alt="Instagram Image" class="w-full h-auto object-cover rounded-lg shadow-lg"></div>
        <div><img src="{{ asset('asset/img/j4.jpg') }}" alt="Instagram Image" class="w-full h-auto object-cover rounded-lg shadow-lg"></div>
        <div><img src="{{ asset('asset/img/j4.jpg') }}" alt="Instagram Image" class="w-full h-auto object-cover rounded-lg shadow-lg"></div>
