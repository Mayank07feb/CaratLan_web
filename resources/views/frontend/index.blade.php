...
@section('content')
    ...
    <div class="relative w-full h-full mx-0 overflow-hidden grid grid-cols-1 md:grid-cols-3 px-4 md:px-8 gap-0">
        ...
        <div class="relative col-span-1 md:col-span-2 aspect-w-16 aspect-h-9 rounded-t-lg md:rounded-l-lg overflow-hidden">
            <iframe class="w-full h-full" src="https://www.youtube.com/embed/Vz0l_OYJofo?si=tYVrySeJr6cU62c6"
    ...
    <div class="relative w-full h-full mx-auto overflow-hidden py-4 grid grid-cols-1 lg:grid-cols-3 px-4 md:px-8 gap-0">
        <!-- Video Section -->
        <div class="relative col-span-1 lg:col-span-2 aspect-w-16 aspect-h-9 rounded-t-lg md:rounded-l-lg overflow-hidden"
            dir="ltr">
            <iframe class="w-full h-full" src="https://www.youtube.com/embed/KhrPUQsYcNo?si=yrOniYEbEwi8kLbl"
                title="YouTube video player" frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                allowfullscreen></iframe>
        </div>
        ...
        <!-- Overlay and Text Section -->
        <aside class="flex items-center justify-center bg-purple-900 p-6 md:p-12 rounded-b-lg md:rounded-r-lg col-span-1"
            dir="rtl">
    ...
    <div class="container mx-auto py-6 bg-gray-50 lg:block md:hidden hidden">
        <div class="relative flex flex-col md:flex-row gap-2 md:gap-0 justify-center">
            ...
            <div class="w-full md:w-1/3 relative mb-6 md:mb-0 left-0">
                <div
                    class="absolute inset-0 flex flex-col justify-center items-center text-center text-black rounded-lg p-0 transform translate-x-1/2">
                    ...
                    <button
                        class="bg-gradient-to-r from-pink-500 to-purple-600 text-white px-4 py-2 rounded text-sm md:text-base transition duration-300 hover:from-pink-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-opacity-50">
            ...
            <div class="w-full md:w-1/3 relative mb-6 md:mb-0 left-2"style="margin-left: 200px;">
                <div
                    class="absolute inset-0 flex flex-col justify-center items-center text-center text-black rounded-lg p-0 transform translate-x-1/3">
                    ...
                    <div class="mb-4 w-1/2">
                        <input type="text" placeholder="Enter Pincode or City"
                            class="w-full p-2 border border-pink-500 rounded text-sm md:text-base focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-opacity-50">
                    </div>
                </div>
                <div class="mt-4">
            ...
            <div class="w-full">
                ...
                <div class=" justify-center items-center text-center text-black my-2">
                    ...
                    <a href="{{ route('appointment') }}"> <button
                            class="bg-gradient-to-r from-pink-500 to-purple-600 text-white px-4 py-2 rounded text-sm md:text-base transition duration-300 hover:from-pink-600 hover:to-purple-700">
    ...
    <div class="flex items-center justify-center py-8 bg-[#231535]">
        <div class="max-w-xl w-full px-6 sm:px-8 md:px-12 lg:px-0 text-center">
            ...
            <!-- Text -->
            <p
                class="text-sm sm:text-base md:text-lg lg:text-md text-purple-300 mb-8 px-2 sm:px-6 md:px-12 lg:px-24 -mt-2">
            ...
            <a href="{{ route('know') }}">
                <button
                    class="w-1/2 md:w-1/3 lg:w-1/4 bg-gradient-to-r from-pink-600 to-purple-700 
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div id="slider1" class="tab-content">
            <div class="relative">
                ...
                <div class="slider-arrows flex justify-between mt-4">
                    <button class="slider-arrow bg-white p-2 rounded-full shadow-md" id="prev1"
                    ...
                    <button class="slider-arrow bg-white p-2 rounded-full shadow-md" id="next1"
        ...
        <div id="slider2" class="tab-content hidden">
            <div class="relative">
                ...
                <div class="slider-arrows flex justify-between mt-4">
                    <button class="slider-arrow bg-white p-2 rounded-full shadow-md" id="prev2"
                        aria-label="Previous Slide">
                        <svg class="w-6 h-6 text-gray-800" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7">
                            </path>
                    ...
                    <button class="slider-arrow bg-white p-2 rounded-full shadow-md" id="next2"
                        aria-label="Next Slide">
                        <svg class="w-6 h-6 text-gray-800" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7">
                            </path>
        ...
        <div class="container mx-auto px-6 lg:px-12">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                ...
                <div class="flex flex-row items-center space-y-4">
                    <img src="{{ asset('asset/img/download.jpeg') }}" alt="Certified & Free Shipping"
                        class="h-44 w-44 object-cover">
                    <a href="{{ route('policy') }}">
                        <div class="text-start">
                            <h3 class="text-md font-semibold mb-2">100% Certified & Free Shipping</h3>
                            <p class="text-sm text-purple-300">Our jewellery always comes with a certificate of
                                authentication.</p>
                        </div>
                    </a>
                </div>
                ...
                <!-- 15 Day Money-Back -->
                <div class="flex flex-row items-center space-y-4">
                    <img src="{{ asset('asset/img/download.jpeg') }}" alt="15 Day Money-Back"
                        class="h-44 w-44 object-cover">
                    <a href="{{ route('policy') }}">
                        <div class="text-start">
                ...
                <div class="flex flex-row items-center space-y-4 lg:pl-24">
                    <img src="{{ asset('asset/img/download.jpeg') }}" alt="Lifetime Exchange"
                        class="h-44 w-44 object-cover">
                    <a href="{{ route('policy') }}">
                        <div class="text-start">
                ...
                <!-- One Year Warranty* -->
                <div class="flex flex-row items-center space-y-4 lg:pl-24">
                    <img src="{{ asset('asset/img/download.jpeg') }}" alt="One Year Warranty"
                        class="h-44 w-44 object-cover">
                    <a href="{{ route('policy') }}">
                        <div class="text-start">
                ...
                <div class="swiper-slide px-4">
                    <div class="w-full p-6 ">
                        <div class="flex justify-center mb-4">
                            <!-- Testimonial Image -->
                            <i
                                class="ri-instagram-line text-5xl bg-gradient-to-r from-pink-500 to-purple-600 bg-clip-text text-transparent"></i>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 bg-red-800 lg:mx-12">
            ...
            <div class="w-full h-full overflow-hidden bg-yellow-400">
                <img src="https://cdn.caratlane.com/media/catalog/product/U/T/UT01166-1Y0000_3_lar.jpg"
                    alt="Product Image" class="h-hull w-full object-cover">
            </div>
    ...
    <div
        ...
        <div class="lg:flex items-center justify-center space-x-4 lg:px-8">
            <div class="flex justify-center">
                <img src="{{ asset('asset/img/purple-gift-icon.png') }}" alt="Gift Icon"
    ...
    <script>
        ...
        document.getElementById('prev1').addEventListener('click', () => {
            const slider = document.querySelector('#slider1 .slider');
            currentSlideIndex1 = (currentSlideIndex1 - 1 + (slider.children.length - visibleSlides + 1)) % (slider
                .children.length - visibleSlides + 1);
            updateSlider(slider, currentSlideIndex1);
        });
        ...
        document.getElementById('prev2').addEventListener('click', () => {
            const slider = document.querySelector('#slider2 .slider');
            currentSlideIndex2 = (currentSlideIndex2 - 1 + (slider.children.length - visibleSlides + 1)) % (slider
                .children.length - visibleSlides + 1);
            updateSlider(slider, currentSlideIndex2);
        });
