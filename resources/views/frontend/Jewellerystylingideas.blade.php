...
<div class="max-w-full mx-auto bg-[#F5F3F1] p-6 mb-6">
    <h2 class="text-3xl font-bold text-center mb-4">Jewellery styling ideas</h2>
</div>
...
<div class="max-w-7xl mx-auto">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <!-- Article 4 -->
        <article class="flex flex-col">
            <img src="{{asset('asset/img/what4.jpeg')}}" alt="Stylish Earring Picks" class="w-full h-64 object-cover rounded-lg mb-4">
            <div class="space-y-2">
        ...
        <!-- Article 5 -->
        <article class="flex flex-col">
            <img src="{{asset('asset/img/what5.jpg')}}" alt="Mangalsutra Designs" class="w-full h-64 object-cover rounded-lg mb-4">
            <div class="space-y-2">
        ...
        <!-- Article 6 -->
        <article class="flex flex-col">
            <img src="{{asset('asset/img/what6.jpg')}}" alt="Gold Pendants" class="w-full h-64 object-cover rounded-lg mb-4">
            <div class="space-y-2">
        ...
        <!-- Article 7 -->
        <article class="flex flex-col">
            <img src="{{asset('asset/img/what7.jpg')}}" alt="Gold Pendants" class="w-full h-64 object-cover rounded-lg mb-4">
            <div class="space-y-2">
                <h2 class="text-xl font-serif font-medium">Trendy 22k Gold Pendants for Effortless Everyday Styling</h2>
                <p class="text-sm text-gray-500">OCTOBER 9, 2024</p>
                <p class="text-gray-600 text-sm">Accessories play a crucial role in taking your look to new heights and expressing your style. Among these, gold pendants hold a special place...</p>
        ...
        <!-- Article 8 -->
        <article class="flex flex-col">
            <img src="{{asset('asset/img/what8.jpg')}}" alt="Gold Pendants" class="w-full h-64 object-cover rounded-lg mb-4">
            <div class="space-y-2">
                <h2 class="text-xl font-serif font-medium">Trendy 22k Gold Pendants for Effortless Everyday Styling</h2>
                <p class="text-sm text-gray-500">OCTOBER 9, 2024</p>
                <p class="text-gray-600 text-sm">Accessories play a crucial role in taking your look to new heights and expressing your style. Among these, gold pendants hold a special place...</p>
        ...
        <!-- Article 9 -->
        <article class="flex flex-col">
            <img src="{{asset('asset/img/what9.jpg')}}" alt="Gold Pendants" class="w-full h-64 object-cover rounded-lg mb-4">
            <div class="space-y-2">
                <h2 class="text-xl font-serif font-medium">Trendy 22k Gold Pendants for Effortless Everyday Styling</h2>
                <p class="text-sm text-gray-500">OCTOBER 9, 2024</p>
                <p class="text-gray-600 text-sm">Accessories play a crucial role in taking your look to new heights and expressing your style. Among these, gold pendants hold a special place...</p>
         ...
         <!-- Article 10 -->
         <article class="flex flex-col">
            <img src="{{asset('asset/img/what10.jpg')}}" alt="Gold Pendants" class="w-full h-64 object-cover rounded-lg mb-4">
            <div class="space-y-2">
                <h2 class="text-xl font-serif font-medium">Trendy 22k Gold Pendants for Effortless Everyday Styling</h2>
                <p class="text-sm text-gray-500">OCTOBER 9, 2024</p>
                <p class="text-gray-600 text-sm">Accessories play a crucial role in taking your look to new heights and expressing your style. Among these, gold pendants hold a special place...</p>
