            ...
            <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden relative">
                        <!-- Product Image -->
                        <div class="h-56 relative"> <!-- Increased the height of the image to h-56 -->
                        ...
                        <div class="px-4 py-3">
                            ...
                            <!-- Product Title -->
                            <h2 class="text-sm font-base text-gray-400 mb-2">Radiant Rivulet Diamond Stud Earrings</h2>

                            <!-- Buttons (Below Price) -->
                            <div class="mt-4 flex space-x-2">
                                <button class="bg-white border border-gray-400 font-semibold py-1 px-8 rounded-lg text-xs">
                                    TRY NOW
                                </button>

                                <button class="bg-white border border-gray-400 py-2 px-3 rounded-lg text-xs flex items-center">
