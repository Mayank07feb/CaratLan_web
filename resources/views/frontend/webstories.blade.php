...
<div class="max-w-full mx-auto bg-[#F5F3F1] p-6 mb-6">
    <h2 class="text-3xl font-bold text-center mb-4">Stories</h2>
</div>
...
<div class="max-w-7xl md:mx-auto mx-4">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <article class="flex flex-col">
            <img src="{{asset('asset/img/web1.jpg')}}" alt="Diwali Gift Ideas" class="w-full h-64 object-cover rounded-lg mb-4">
            <div class="space-y-2">
        ...
        <!-- Article 2 -->
        <article class="flex flex-col">
            <img src="{{asset('asset/img/web2.jpg')}}" alt="Festive Postcard Rings" class="w-full h-64 object-cover rounded-lg mb-4">
            <div class="space-y-2">
        ...
        <!-- Article 3 -->
        <article class="flex flex-col">
            <img src="{{asset('asset/img/web3.jpg')}}" alt="Stacking Bangle Designs" class="w-full h-64 object-cover rounded-lg mb-4">
            <div class="space-y-2">
        ...
        <!-- Article 4 -->
        <article class="flex flex-col">
            <img src="{{asset('asset/img/web4.jpg')}}" alt="Stylish Earring Picks" class="w-full h-64 object-cover rounded-lg mb-4">
            <div class="space-y-2">
        ...
        <!-- Article 5 -->
        <article class="flex flex-col">
            <img src="{{asset('asset/img/web5.jpg')}}" alt="Mangalsutra Designs" class="w-full h-64 object-cover rounded-lg mb-4">
            <div class="space-y-2">
        ...
        <!-- Article 6 -->
        <article class="flex flex-col">
            <img src="{{asset('asset/img/web6.jpg')}}" alt="Gold Pendants" class="w-full h-64 object-cover rounded-lg mb-4">
            <div class="space-y-2">
        ...
        <!-- Article 7 -->
        <article class="flex flex-col">
            <img src="{{asset('asset/img/web7.jpg')}}" alt="Gold Pendants" class="w-full h-64 object-cover rounded-lg mb-4">
            <div class="space-y-2">
                <h2 class="text-xl font-serif font-medium">Trendy 22k Gold Pendants for Effortless Everyday Styling</h2>
                <p class="text-sm text-gray-500">OCTOBER 9, 2024</p>
                <p class="text-gray-600 text-sm">Accessories play a crucial role in taking your look to new heights and expressing your style. Among these, gold pendants hold a special place...</p>
        ...
        <!-- Article 8 -->
        <article class="flex flex-col">
            <img src="{{asset('asset/img/web8.jpg')}}" alt="Gold Pendants" class="w-full h-64 object-cover rounded-lg mb-4">
            <div class="space-y-2">
                <h2 class="text-xl font-serif font-medium">Trendy 22k Gold Pendants for Effortless Everyday Styling</h2>
                <p class="text-sm text-gray-500">OCTOBER 9, 2024</p>
                <p class="text-gray-600 text-sm">Accessories play a crucial role in taking your look to new heights and expressing your style. Among these, gold pendants hold a special place...</p>
        ...
        <!-- Article 9 -->
        <article class="flex flex-col">
            <img src="{{asset('asset/img/web9.jpg')}}" alt="Gold Pendants" class="w-full h-64 object-cover rounded-lg mb-4">
            <div class="space-y-2">
                <h2 class="text-xl font-serif font-medium">Trendy 22k Gold Pendants for Effortless Everyday Styling</h2>
                <p class="text-sm text-gray-500">OCTOBER 9, 2024</p>
                <p class="text-gray-600 text-sm">Accessories play a crucial role in taking your look to new heights and expressing your style. Among these, gold pendants hold a special place...</p>
         ...
         <!-- Article 10 -->
         <article class="flex flex-col">
            <img src="{{asset('asset/img/web10.jpg')}}" alt="Gold Pendants" class="w-full h-64 object-cover rounded-lg mb-4">
            <div class="space-y-2">
                <h2 class="text-xl font-serif font-medium">Trendy 22k Gold Pendants for Effortless Everyday Styling</h2>
                <p class="text-sm text-gray-500">OCTOBER 9, 2024</p>
                <p class="text-gray-600 text-sm">Accessories play a crucial role in taking your look to new heights and expressing your style. Among these, gold pendants hold a special place...</p>
